...
export function CreatorPlanCard({ snapshot }) {
  const items = [
    ...
    ['Active Projects', `${snapshot.usage.activeSeries}/${snapshot.limits.maxActiveSeries} · Remaining ${snapshot.remaining.seriesLeft}`],
    ['Videos', `${snapshot.usage.totalEpisodes}/${snapshot.limits.maxTotalEpisodes} · Remaining ${snapshot.remaining.episodesLeft}`],
