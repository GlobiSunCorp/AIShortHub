...
export const CREATOR_STUDIO_GROUPS = [
  {
    ...
    title: 'Workspace',
    items: [
      { id: 'dashboard', label: 'Dashboard', to: '/creator#overview', mode: 'page', status: 'Overview', hint: 'Quota, launch readiness, and action center in one place.' },
      { id: 'my-series', label: 'My Series', to: '/creator#content', mode: 'page', status: '3 drafts', hint: 'Manage story metadata, episode structure, and publishing setup.' },
      { id: 'upload-assets', label: 'Upload Assets', to: '/creator#assets', mode: 'page', status: '2 missing', hint: 'Poster, trailer, subtitle, and promo asset intake.' },
      { id: 'pricing', label: 'Pricing & Monetization', to: '/creator#pricing', mode: 'page', status: '80% ready', hint: 'Complete title pricing and monetization configuration.' },
  ...
  },
  {
    ...
    title: 'Growth Tools',
    items: [
      { id: 'motion-poster', label: 'Motion Poster', to: '/creator#motion-poster', mode: 'module', tag: 'Pro', status: '1 rendering', hint: 'Generate motion-poster variants for launch campaigns.' },
